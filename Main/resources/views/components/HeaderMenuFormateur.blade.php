            ...
            <div class="container-fluid">
                ...
                <div class="dropdown d-inline-block">
                  ...
                  >
                    <img
                        ...
                        src="{{ asset('assets/images/users/HeaderAvatar.png') }}"
                        alt="Header Avatar"
                    />
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item d-block" href="#"
                      ><i class="mdi mdi-settings-outline"></i> Settings</a
                    >
                    <a class="dropdown-item" href="./pages-lock-screen.html"
                      ><i
              ...
              <div>
                ...
                <div class="navbar-brand-box">
                  <a href="{{ url('indexFormateur') }}" class="logo logo-dark">
                      <span class="logo-sm">
              ...
              <ul class="metismenu list-unstyled" id="side-menu">
                  ...
                  <li>
                      ...
                      <ul class="sub-menu" aria-expanded="false">
                          <li><a href="{{ url('ListGroupes') }}">List des Groupes</a></li>
                      </ul>
                  </li>
