                ...
                <div class="navbar-header">
                    <div class="container-fluid">
                        <div class="float-end">
                            ...
                            {{-- notification icon --}}
                            <div class="dropdown d-inline-block notificationDiv">
                                <button type="button" class="btn header-item noti-icon waves-effect"
                                    id="page-header-notifications-dropdown" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    <i class="mdi mdi-bell-outline"></i>
                                    <span class="badge rounded-pill bg-danger " data-count="3">3</span>
                                </button>
                                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="{{ route('ChaqueFormateur') }}" class=" waves-effect"> chaque
                                            formateur</a></li>
                                    <li><a href="{{ route('CreateEmploi') }}" class=" waves-effect"> chaque group</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="{{ route('determine-type-class-room') }}">Afictaion des types</a>
                                    </li>
                                </ul>
                            </li>
