<x-HeaderMenuFormateur>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('update_settings') }}" method="POST" class="outer-repeater" enctype="multipart/form-data">
                @csrf
                    ...
                    <div data-repeater-item class="outer">
                        ...
                        <div class="mb-3">
                            ...
                            @if($user->image)
                                ...
                                <img src="{{ asset('uploads/' . $user->image) }}" alt="Current Image" style="max-width: 100px;">
                            @endif
                        </div>
