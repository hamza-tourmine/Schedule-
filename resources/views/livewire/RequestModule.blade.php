  {{-- Model --}}
  <div wire:ignore.self class="modal fade col-9" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
          ...
          <div class="modal-content  col-9">
              ...
              <form wire:submit.prevent='UpdateSession'>
                                  ...
                                  <div style="width: 100%;" style="" class="checkboxContainer ">
                                      @foreach ($groups as $group)
                                          <span style="display: block">
                                              <input class="modulesoption" type="checkbox"
                                                  wire:model="selectedGroups.{{ $group->id }}"
                                                  value="{{ $group->id }}">
                  ...
                  <div class="modal-footer">
                      ...
                      @if ($isCaseEmpty)
                          <button id="SaveAndUpdate" data-bs-dismiss="modal" type="submit"
