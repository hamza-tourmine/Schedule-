                    ...
                    @foreach (['MatinSE1', 'MatinSE2', 'AmidiSE3', 'AmidiSE4'] as $sessionType)
                        ...
                        @foreach ($sissions as $sission)
                            @if ($sission->day === $day &&
                                ...
                                <td wire:click="updateCaseStatus(false)" style="height: 50px !important; overflow: hidden" colspan="1" rowspan="1" data-bs-toggle="modal" data-bs-target="#exampleModal" class="TableCases" id="{{ $day . $sessionType . $group->id }}">
                                    @if ($item === 'Formateur')
                                        {{ $sission->user_name }}
                                    @elseif ($item === 'Module')
                        ...
                        @endforeach
                        @if (!$sessionFound)
                            <td wire:click="updateCaseStatus(true)" style="height: 50px !important; overflow: hidden" colspan="1" rowspan="1" data-bs-toggle="modal" data-bs-target="#exampleModal" class="TableCases" id="{{ $day . $sessionType . $group->id }}"></td>
                        @endif
                    @endforeach
                @endforeach
            </tr><tr>
